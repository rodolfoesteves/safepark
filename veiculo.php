      ...
      <div class="container">
        <div class="row text-center">
          <div class="col-md-3">
            ...
            <img src="imagens\carro_moto.png" class="center-block img-responsive img-rounded" id="img_usuario">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" role="form">
              ...
              <div class="form-group has-feedback" id="marca">
                <div class="col-sm-2">
                  <label for="inputEmail3" class="control-label">
                    <span style="font-weight: normal;">Marca:</span>
                  </label>
                </div>
                <div class="col-sm-10">
                  <input type="text" class="form-control input-lg" id="inputEmail3" placeholder="Marca">
                  <span class="fa fa-check form-control-feedback"></span>
                </div>
              </div>
              <div class="form-group has-feedback" id="modelo">
                <div class="col-sm-2">
                  <label for="inputEmail3" class="control-label">
                    <span style="font-weight: normal;">Modelo:</span>
                  </label>
                </div>
                <div class="col-sm-10">
                  <input type="text" class="form-control input-lg" id="inputEmail3" placeholder="Modelo">
                  <span class="fa fa-check form-control-feedback"></span>
                </div>
              </div>
              <div class="form-group has-feedback" id="cor">
                <div class="col-sm-2">
                  <label for="inputEmail3" class="control-label">
                    <span style="font-weight: normal;">Cor:</span>
                  </label>
                </div>
                <div class="col-sm-10">
                  <input type="text" class="form-control input-lg" id="inputEmail3" placeholder="cor">
                  <span class="fa fa-check form-control-feedback"></span>
                </div>
              </div>
              <div class="form-group has-feedback" id="ano">
                <div class="col-sm-2">
                  <label for="inputEmail3" class="control-label">
                    <span style="font-weight: normal;">Ano:</span>
                  </label>
                </div>
                <div class="col-sm-10">
                  <input type="text" class="form-control input-lg" id="inputEmail3" placeholder="Ano">
                  <span class="fa fa-check form-control-feedback"></span>
                </div>
              </div>
              <div class="form-group has-feedback" id="placa">
                <div class="col-sm-2">
                  <label for="inputEmail3" class="control-label">
                ...
                <div class="col-sm-10">
                  <input type="email" class="form-control input-lg" id="inputEmail3" placeholder="Placa">
                  <span class="fa fa-check form-control-feedback"></span>
                </div>
              </div>
