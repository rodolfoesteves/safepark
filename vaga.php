    ...
    <div class="navbar navbar-default navbar-fixed-top navbar-inverse" id="menuTopo">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" id="marca" href="index.html"><span><b>Vagas</b></span></a>
        </div>
    ...
    <div class="navbar navbar-default navbar-fixed-top navbar-inverse" id="menuTopo">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-ex-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li id="home">
              <a href="index.html" id="home"><i class="fa fa-home fa-lg pull-left text-success"></i>Home</a>
            </li>
            <li id="usuario">
              <a href="usuario"><i class="fa fa-fw fa-lg fa-user pull-left text-success"></i>Dados Pessoais</a>
            </li>
            <li>
              <a href="veiculo" id="veiculo"><i class="fa fa-automobile fa-fw fa-lg pull-left text-success"></i>Veículos</a>
            </li>
            <li class="dropdown">
      ...
      <div class="container">
        <div class="row text-center">
          <div class="col-md-3">
            ...
            <img src="imagens\deficiente-físico.png" class="center-block img-responsive img-rounded">
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form">
              ...
              <div class="form-group has-feedback" id="prontuario">
                <div class="col-sm-2">
                  <label for="inputEmail3" class="control-label">
                    <span style="font-weight: normal;">Tipo:</span>
                  </label>
                </div>
                <div class="col-sm-10">
                  <input type="text" class="form-control input-lg" id="inputEmail3" placeholder="Tipo">
                  <span class="fa fa-check form-control-feedback"></span>
                </div>
              </div>
              <div class="form-group has-feedback" id="nome">
                <div class="col-sm-2">
                  <label for="inputEmail3" class="control-label">
                    <span style="font-weight: normal;">Descrição:</span>
                  </label>
                </div>
                <div class="col-sm-10">
                  <input type="text" class="form-control input-lg" id="inputEmail3" placeholder="Descrição">
                  <span class="fa fa-check form-control-feedback"></span>
                </div>
              </div>
